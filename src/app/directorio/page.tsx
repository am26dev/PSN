...
import { listarUnidadesPublicasCached } from "@/lib/services/unidade.service";
import { listarSeguradorasAtivas } from "@/lib/services/seguro.service";
...
export default async function DirectorioPage({
  ...
  const { total, unidades, totalPaginas, paginaAtual } = await listarUnidadesPublicasCached({
    tipo,
    provincia,
  ...
  }).catch(() => ({ total: 0, unidades: [], totalPaginas: 1, paginaAtual: 1 }));

  const seguradoras = await listarSeguradorasAtivas();
