...
import { listarDependentesCompletos } from "@/lib/services/dependente.service";
import { listarMarcacoesDoUtente } from "@/lib/services/marcacao.service";
...
export default async function ContaPage() {
  ...
  const [dependentes, marcacoes] = await Promise.all([
    listarDependentesCompletos(utente.id),
    listarMarcacoesDoUtente(utente.id),
  ]);
